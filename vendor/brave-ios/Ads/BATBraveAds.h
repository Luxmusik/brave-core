...
- (void)getInlineContentAd:(NSString* size, void (^)(BOOL success, NSString* title, NSString* description, NSString* imageUrl, NSString* ctaText))completion NS_SWIFT_NAME(getInlineContentAd(_:));
